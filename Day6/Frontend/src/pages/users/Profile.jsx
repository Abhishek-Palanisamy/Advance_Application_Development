...
function Profile() {
  ...
  // Fetch the array of items from sessionStorage
  const itemDetails = JSON.parse(sessionStorage.getItem('itemDetails')) || [];
        ...
        <div className="top-part">
          <div className="profile-info">
            <div className="profile-image-container" style={{ position: 'relative' }}>
              <div className="image-text" style={{ position: 'absolute', top: '32%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '85px', fontWeight: 'bold', textAlign: 'center', color: 'black' }}>
                {firstLetter}
              </div>
            </div>

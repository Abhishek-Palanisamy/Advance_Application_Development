...
function Home() {
  ...
  return (
    ...
    <Link to="/user/flowers"> <div className='icon-text'>Flowers</div></Link>
    </div>
    <div className='icon-border1'>
    ...
    <Link to="/user/cake"> <div className='icon-text'>Cakes</div></Link>
    </div>
    <div className='icon-border1'>
    <img src='https://cdn.igp.com/f_auto,q_auto,t_pnopt0prodlp/banners/w-tiles-personalize-v202306.png'/>
    <Link to="/user/personalized"><div className='icon-text'>Custom</div></Link>
    </div>
    <div className='icon-border1'>
  ...
  <Link to="/user/personalized"> <div class="grid-item">
 ...
 <div className='things'>Mugs</div>
  ...
  <Link to="/user/cake"> <div class="grid-item">
